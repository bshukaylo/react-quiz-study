...
class Auth extends Component {
    ...
    loginHandler = async () => {
        ...
        try {
            const response = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${FIREBASE_API_KEY}`, authData);
    ...
    registerHandler = async () => {
        ...
        try {
            const response = await axios.post(`https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=${FIREBASE_API_KEY}`, authData);
            console.log(response.data);
        } catch (e) {
            console.error(e);
        }
